@testset "Atmosphere" begin
    ...
    # alt 300 km:
    alt = 300.0 * 1e3
    atm = SATORBIT.calc_atmosphere(date_time, alt, lat, lon, f107, f107a, ap)
    ...
    @test T ≈ 848.0 atol=1 # reference value from NRLMSISE-00 https://kauai.ccmc.gsfc.nasa.gov/instantrun/nrlmsis/
    ...
    @test T ≈ 802.8 atol=1 # reference value from NRLMSISE-00 https://kauai.ccmc.gsfc.nasa.gov/instantrun/nrlmsis/
    ...
    @test T ≈ 850.7 atol=1 # reference value from NRLMSISE-00 https://kauai.ccmc.gsfc.nasa.gov/instantrun/nrlmsis/
